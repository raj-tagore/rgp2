...
class ExecuteTaskSolutionAction(genpy.Message):
  _md5sum = "cb959f1268a54800f188b5a0670dfbb7"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.solution.start_scene.robot_state.joint_state.position))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity))
      length = len(self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort))
      _x = self
      ...
      _x = self.action_goal.goal.solution.start_scene.robot_state.is_diff
      buff.write(_get_struct_B().pack(_x))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.solution.start_scene.world.octomap.octomap.binary
      buff.write(_get_struct_B().pack(_x))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.solution.start_scene.world.octomap.octomap.resolution
      buff.write(_get_struct_d().pack(_x))
      length = len(self.action_goal.goal.solution.start_scene.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.solution.start_scene.world.octomap.octomap.data))
      _x = self.action_goal.goal.solution.start_scene.is_diff
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.solution.task_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.solution.start_scene.robot_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.robot_model_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_goal.goal.solution.start_scene.allowed_collision_matrix.default_entry_values = s.unpack(str[start:end])
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.world.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.solution.start_scene.world.octomap.octomap.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.action_goal.goal.solution.start_scene.world.octomap.octomap.data = s.unpack(str[start:end])
      start = end
      end += 1
