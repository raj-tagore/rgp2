...
class Solution(genpy.Message):
  _md5sum = "99d1c3987be234153a012de7a8b6d664"
  _type = "moveit_task_constructor_msgs/Solution"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# id of generating task
string task_id
...
duration time_from_start
"""
  __slots__ = ['task_id','start_scene','sub_solution','sub_trajectory']
  _slot_types = ['string','moveit_msgs/PlanningScene','moveit_task_constructor_msgs/SubSolution[]','moveit_task_constructor_msgs/SubTrajectory[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       task_id,start_scene,sub_solution,sub_trajectory
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.start_scene.robot_state.joint_state.position))
      length = len(self.start_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.start_scene.robot_state.joint_state.velocity))
      length = len(self.start_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.start_scene.robot_state.joint_state.effort))
      _x = self
      ...
      _x = self.start_scene.robot_state.is_diff
      buff.write(_get_struct_B().pack(_x))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.start_scene.allowed_collision_matrix.default_entry_values))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.start_scene.world.octomap.octomap.binary
      buff.write(_get_struct_B().pack(_x))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.start_scene.world.octomap.octomap.resolution
      buff.write(_get_struct_d().pack(_x))
      length = len(self.start_scene.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.start_scene.world.octomap.octomap.data))
      _x = self.start_scene.is_diff
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.start_scene.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.start_scene.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.start_scene.robot_state.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.start_scene.robot_state.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.start_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.start_scene.robot_model_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.start_scene.allowed_collision_matrix.default_entry_values = s.unpack(str[start:end])
      ...
      if python3:
        self.start_scene.world.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.start_scene.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.start_scene.world.octomap.octomap.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.start_scene.world.octomap.octomap.data = s.unpack(str[start:end])
      start = end
      end += 1
