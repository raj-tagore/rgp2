...
(cl:defclass <StageStatistics> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (num_failed
    ...
    :initform 0)
   (total_compute_time
    :reader total_compute_time
    :initarg :total_compute_time
    :type cl:float
    :initform 0.0))
)
...
(cl:ensure-generic-function 'total_compute_time-val :lambda-list '(m))
(cl:defmethod total_compute_time-val ((m <StageStatistics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_task_constructor_msgs-msg:total_compute_time-val is deprecated.  Use moveit_task_constructor_msgs-msg:total_compute_time instead.")
  (total_compute_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <StageStatistics>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'total_compute_time))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <StageStatistics>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'failed)))
    ...
    (cl:setf (cl:slot-value msg 'total_compute_time) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StageStatistics>)))
  ...
  "a3065cf7e54eaf169fb84102f63f1ac2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StageStatistics)))
  "Returns md5sum for a message object of type 'StageStatistics"
  "a3065cf7e54eaf169fb84102f63f1ac2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StageStatistics>)))
  ...
  (cl:format cl:nil "# dynamically changing information for a stage~%~%# unique id within task~%uint32 id~%~%# successful solution IDs of this stage, sorted by increasing cost~%uint32[] solved~%~%# (optional) failed solution IDs of this stage~%uint32[] failed~%# number of failed solutions (if failed is empty)~%uint32   num_failed~%# total computation time in seconds~%float64 total_compute_time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StageStatistics)))
  "Returns full string definition for message of type 'StageStatistics"
  (cl:format cl:nil "# dynamically changing information for a stage~%~%# unique id within task~%uint32 id~%~%# successful solution IDs of this stage, sorted by increasing cost~%uint32[] solved~%~%# (optional) failed solution IDs of this stage~%uint32[] failed~%# number of failed solutions (if failed is empty)~%uint32   num_failed~%# total computation time in seconds~%float64 total_compute_time~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <StageStatistics>))
  ...
  (cl:list 'StageStatistics
    ...
    (cl:cons ':total_compute_time (total_compute_time msg))
))
