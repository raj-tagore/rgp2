...
class SubTrajectory {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('execution_info')) {
        this.execution_info = initObj.execution_info
      }
      else {
        this.execution_info = new TrajectoryExecutionInfo();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [execution_info]
    bufferOffset = TrajectoryExecutionInfo.serialize(obj.execution_info, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [execution_info]
    data.execution_info = TrajectoryExecutionInfo.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += TrajectoryExecutionInfo.getMessageSize(object.execution_info);
  ...
  static md5sum() {
    ...
    return 'fb21ee72670bdb94390fdedcd43be53f';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.execution_info !== undefined) {
      resolved.execution_info = TrajectoryExecutionInfo.Resolve(msg.execution_info)
    }
    else {
      resolved.execution_info = new TrajectoryExecutionInfo()
    }
