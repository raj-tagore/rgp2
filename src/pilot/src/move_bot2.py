...
def random_pose():
    ...
    pose.pose.position.x = np.random.uniform(0, 0.5) #0.25
...
if __name__ == '__main__':
    ...
    pub = rospy.Publisher('/cartesian_impedance_example_controller/equilibrium_pose2', PoseStamped, queue_size=1)
    rate = rospy.Rate(1)
    try:
